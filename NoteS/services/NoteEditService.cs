    ...
    AccountInformationService accountInformationService)
{
    ...
    public bool Delete(Field<INotePath, string> pathNote, Field<IAccName, string> owner)
    {
        var note = noteInformationService.Get(pathNote, owner);
    ...
    public Note EditContentNote(Field<INotePath, string> pathNote, Field<IAccName, string> owner,
    ...
    public Note EditContentNote(Field<INotePath, string> pathNote, NoteEditContentRequestDto requestDto)
    {
        var note = noteInformationService.Get(pathNote);
        note.Content = requestDto.Content;
        return repository.SaveContent(note);
    ...
    public Note CreateNote(Field<IAccName, string> accountName, NoteCreateRequestDto requestDto)
    {
