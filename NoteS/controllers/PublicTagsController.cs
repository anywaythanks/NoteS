    ...
    : GeneralPreconditionController
{
    ...
    public IActionResult Tags([FromRoute] AccountName accountName,
    ...
    public IActionResult CreateTag([FromRoute] AccountName accountName,
    ...
    public IActionResult DelTag([FromRoute] AccountName accountName,
        [FromRoute] NotePath pathNote,
        [FromBody] DeleteTagRequestDto delete)
    {
        return ExecuteA(
            () => tagEditService.Delete(nm.Of(pathNote), am.Of(accountName),
                tm.Of(delete))
                ? NoContent()
    ...
    public IActionResult AddTag([FromRoute] AccountName accountName,
        [FromRoute] NotePath pathNote,
        [FromBody] CreateTagRequestDto createTagRequestDto)
    {
