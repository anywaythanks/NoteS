...
Для фронтенда клиент на Angular. Три базы данных: PostgreSQL для хранения метаданных, ElasticSearch для хранения содержания и 
Kafka для транзакционной целостности (Saga). Для миграций используется Liquibase. Для генерации документации Doxygen.
