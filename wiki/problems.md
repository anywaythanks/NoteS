...
- ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png)  `NoteType#COMMENT_REDACTED` это стейт и по-хорошему он должен быть в новом enum `State`, но оно имеет немного иное свойство, являясь меткой, ничего не значащей для модели. Поэтому это сложный вопрос... Который я не буду решать в этой жизни, а вот в следующей обязательно приложу все минимальные усилия.
